<?php
    ...
    //wczytanie konfiguracji i funkcji
    include('cfg.php');
...
<body>
    ...
    <header>
        <h1><a href="index.php?id=1">Aksolotle</a></h1>
        <nav class="navbar">
            <ul>
                <li><a href="index.php?id=1">Strona główna</a></li>
                <li><a href="index.php?id=2">Hodowla</a></li>
                <li><a href="index.php?id=3">Odżywianie</a></li>
                <li><a href="index.php?id=4">Zdrowie i pielęgnacja</a></li>
                <li><a href="index.php?id=5">Ciekawostki</a></li>
                <li><a href="index.php?id=6">Galeria</a></li>
                <li><a href="index.php?id=7">Filmy</a></li>
                <li><a href="index.php?id=11">Sklep</a></li>
