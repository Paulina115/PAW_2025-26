...
if ($_GET['idp'] == '' || $_GET['idp'] == 'glowna') {
    $strona = 'html/glowna.html';
} elseif ($_GET['idp'] == 'hodowla') {
    $strona = 'html/hodowla.html';
} elseif ($_GET['idp'] == 'odżywianie') {
    $strona = 'html/odżywianie.html';
} elseif ($_GET['idp'] == 'zdrowie') {
    $strona = 'html/zdrowie.html';
...
<body>
    ...
    <main>
        ...
        if (file_exists($strona)) {
            ...
            echo "<h2>Taka strona nie istnieje.</h2>";
        }
        ?>
        <div class="time-div">
