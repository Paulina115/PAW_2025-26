<?php
    ...
    //Pobranie id podstrony
    $page_id = $_GET['id'] ?? 1;

    //Obsługa strony do kontaktu
    if ($page_id == 7) { 

        // wysłanie maila z formularza
        if (isset($_POST['wyslij_kontakt'])) {
            WyslijMailKontakt("jurewiczp2@domena.pl"); 
        }
        ...
        //Wyświetlenie formularza do kontaktu
        $treść = PokazKontakt();
    }
    else {
        // w innym przypadku wyświetla inna podstrone
